...
def main():
    parser = argparse.ArgumentParser(description='Run inference with MMed-Llama-3-8B on medical datasets')
    ...
    parser.add_argument('--output_dir', type=str, default='results_mmed', help='Directory to save results')
    ...
    try:
        ...
        # 方法 3: 最基本的加載方式
        print("嘗試使用基本方法加載模型")
        model = AutoModelForCausalLM.from_pretrained("Henrychur/MMed-Llama-3-8B")
